...
Jump to [Use Docker Hub image](https://github.com/nholuong/devops-toolkit?tab=readme-ov-file#use-the-official-image-from-docker-hub) for instead.

**1. Clone the Repository:**

```bash
git clone https://github.com/nholuong/devops-toolkit.git
```
